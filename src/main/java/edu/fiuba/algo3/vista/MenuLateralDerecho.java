...
public class MenuLateralDerecho extends VBox implements Observer {
    ...
    public void actualizarLabelObjetivoGeneral() {
        labelObjetivoGeneral.setText("Objetivo general: \n Dominar 30 paises (" + juego.getTurno().obtenerJugadorTurnoActual().cantidadPaisesDominados() + "/30 dominados por " + juego.getTurno().obtenerJugadorTurnoActual().obtenerNombre() + ")" );
    }
